...
@section('title', 'FIFA WORLD CUP, RUSSIA 18')
@section('content')
...
@section('slide')
    ...
    <div class="slider-area owl-carousel">
        <div class="sliding-item">
            <img src="{!! asset('assets/images/slider-show/1.jpg') !!}" alt="slider-img">
        ...
        <div class="sliding-item">
            <img src="{!! asset('assets/images/slider-show/2.jpg') !!}" alt="slider-img">
            <div class="tonight-match">
                <div class="sliding-match">
                    <h4><a href="#">to night</a></h4>
                    <ul class="match-vs">
                        <li><img src="{!! asset('assets/images/club-logo/logo/chelsea.png') !!}" alt="club logo"><span>chelsea</span></li>
                        <li class="vs">
                            <h4>vs</h4>
                        </li>
                        <li><img src="{!! asset('assets/images/club-logo/logo/chelsea.png') !!}" alt="club logo"><span>arsenal</span></li>
                    </ul>
                </div>
            </div>
        </div>
